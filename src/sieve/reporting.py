...
_REPORT_CSS_MONOCHROME = """
    :root { color-scheme: dark; --bg: #0b0b0b; --panel: #141414; --panel-raised: #191919; --line: #303030; --text: #f2f2f2; --muted: #a3a3a3; --quiet: #737373; }
    * { box-sizing: border-box; }
    body { margin: 0; background: var(--bg); color: var(--text); font: 16px/1.6 Inter, ui-sans-serif, system-ui, sans-serif; }
    main { width: min(1200px, calc(100% - 3rem)); margin: auto; }
    section { padding: 5rem 0; border-bottom: 1px solid var(--line); }
    h1, h2, h3, p { margin-top: 0; } h1, h2, h3 { line-height: 1.04; letter-spacing: -.04em; } h2 { max-width: 760px; font-size: clamp(2rem, 4vw, 3.5rem); } h3 { font-size: 1.08rem; }
    .eyebrow, .card-kicker { color: var(--muted); font-size: .7rem; font-weight: 800; letter-spacing: .14em; text-transform: uppercase; }
    .brand-header { display: flex; align-items: center; justify-content: space-between; padding: 1.25rem 0; border-bottom: 1px solid var(--line); color: var(--muted); font-size: .78rem; letter-spacing: .03em; } .brand-header p { margin: 0; } .brand { display: inline-flex; align-items: center; gap: .65rem; color: var(--text); font-size: .92rem; font-weight: 800; letter-spacing: .13em; text-decoration: none; } .brand-logo { width: 38px; height: 30px; filter: grayscale(1) brightness(2.1); }
    .hero { padding: clamp(4.5rem, 10vw, 8rem) 0 4.5rem; } .hero h1 { max-width: 800px; margin-bottom: 1.35rem; font-size: clamp(2.8rem, 6vw, 4.85rem); } .hero-copy { max-width: 640px; color: var(--muted); font-size: 1.1rem; } .scope { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; margin: 3rem 0 0; padding: 1px; background: var(--line); } .scope div { display: grid; gap: .35rem; padding: 1.25rem; background: var(--panel); } .scope dt { color: var(--text); font-size: 1.7rem; font-weight: 750; line-height: 1; } .scope dd { margin: 0; color: var(--muted); font-size: .78rem; text-transform: uppercase; letter-spacing: .1em; }
    .method-steps { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; margin: 2rem 0 0; padding: 1px; background: var(--line); list-style: none; } .method-steps li { padding: 1.5rem; background: var(--panel); } .method-steps span { display: block; margin-bottom: 1.35rem; color: var(--quiet); font-size: .7rem; font-weight: 800; letter-spacing: .13em; } .method-steps strong { display: block; font-size: 1.2rem; } .method-steps p { margin: .45rem 0 0; color: var(--muted); }
    .section-heading > p:last-child, .summary-copy { color: var(--muted); } .two-by-two-cells { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1px; margin-top: 2rem; padding: 1px; background: var(--line); } .outcome-cell { min-height: 190px; padding: 1.5rem; background: var(--panel); } .outcome-cell > p { margin-bottom: .5rem; color: var(--muted); font-size: .8rem; } .outcome-cell h3 { margin-bottom: 1.3rem; } .outcome-cell strong { display: inline-block; margin-right: .3rem; font-size: 3rem; line-height: 1; } .outcome-cell span { color: var(--muted); } .outcome-cell small { display: block; margin-top: 1rem; color: var(--quiet); }
    .summary-copy { display: grid; grid-template-columns: repeat(2, 1fr); gap: 2rem; max-width: 900px; } .summary-copy strong { color: var(--text); }
    .evidence-cards { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1px; padding: 1px; background: var(--line); } .evidence-card { padding: 1.5rem; background: var(--panel); } .evidence-card.reasoning-insensitive, .evidence-card.constraint-sensitive { border-top: 2px solid var(--text); } .evidence-card dl { display: grid; grid-template-columns: repeat(2, 1fr); gap: .85rem; } .evidence-card dt { color: var(--muted); font-size: .72rem; text-transform: uppercase; letter-spacing: .08em; } .evidence-card dd { margin: .2rem 0 0; font-weight: 700; overflow-wrap: anywhere; } .badge { display: inline-block; padding: .2rem .5rem; border: 1px solid var(--line); border-radius: 100px; color: var(--text); font-size: .72rem; font-weight: 750; white-space: nowrap; } .badge.stable { background: #202020; } .badge.changed { background: #303030; } .swap { display: grid; gap: .3rem; margin: 1.3rem 0; padding: 1rem; border-left: 2px solid var(--text); background: #101010; overflow-wrap: anywhere; } .swap span { color: var(--muted); font-size: .68rem; font-weight: 750; letter-spacing: .1em; text-transform: uppercase; } details { border-top: 1px solid var(--line); padding-top: 1rem; } summary { cursor: pointer; color: var(--text); font-weight: 700; } pre { max-height: 14rem; overflow: auto; padding: .9rem; border: 1px solid var(--line); background: #0a0a0a; color: #d4d4d4; font-size: .75rem; white-space: pre-wrap; }
    .table-wrap { overflow-x: auto; border: 1px solid var(--line); } table { width: 100%; border-collapse: collapse; min-width: 650px; } th, td { padding: .95rem 1rem; border-bottom: 1px solid var(--line); text-align: left; } th { color: var(--muted); font-size: .7rem; letter-spacing: .1em; text-transform: uppercase; } tbody tr:last-child td { border-bottom: 0; } tbody tr:nth-child(even) { background: #111; }
    #honest-limitations { margin: 5rem 0; padding: 1.5rem; border: 1px solid var(--line); border-left: 2px solid var(--text); background: var(--panel); } #honest-limitations h2 { margin-bottom: 1rem; } #honest-limitations ol { max-width: 900px; margin: 0; padding-left: 1.25rem; } #honest-limitations li + li { margin-top: .7rem; }
    footer { display: flex; gap: 1rem; justify-content: space-between; padding: 2rem 0 3rem; color: var(--muted); font-size: .78rem; } footer strong { color: var(--text); letter-spacing: .1em; } footer span { max-width: 640px; text-align: right; }
    @media (max-width: 780px) { main { width: min(100% - 1.5rem, 1200px); } section { padding: 3.5rem 0; } .hero { padding: 4.25rem 0 3.5rem; } .brand-header, footer { align-items: flex-start; flex-direction: column; gap: .65rem; } .scope, .method-steps, .two-by-two-cells, .summary-copy, .evidence-cards { grid-template-columns: 1fr; } footer span { text-align: left; } }
"""
